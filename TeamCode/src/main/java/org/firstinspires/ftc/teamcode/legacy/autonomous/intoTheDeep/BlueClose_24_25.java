...
@Autonomous(name = "BlueClose_24_25")
public class BlueClose_24_25 extends LinearOpMode {
    ...
    Pose2d startPos = new Pose2d(64, -12, Math.toRadians(270));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        for(int i=0; i<2; i++){
            ...
            TrajectorySequence seq2 = drive.trajectorySequenceBuilder(startPos)
                    .lineToLinearHeading(new Pose2d(44, -64+(i*10), Math.toRadians(180)))
                    .build();
            ...
            TrajectorySequence seq3 = drive.trajectorySequenceBuilder(seq2.end())
                    .lineToLinearHeading(new Pose2d(60.5+(0.5*i),-62.5-(0.5*i), Math.toRadians(135)))
                    .build();
