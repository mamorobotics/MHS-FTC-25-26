...
@Autonomous(name = "BlueFar_24_25")
public class BlueFar_24_25 extends LinearOpMode {
    ...
    Pose2d startPos = new Pose2d(63, 12, Math.toRadians(180));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence seq2 = drive.trajectorySequenceBuilder(startPos)
                .lineToLinearHeading(new Pose2d(34.5, 0, Math.toRadians(0)))
                .build();
        ...
        TrajectorySequence seq3 = drive.trajectorySequenceBuilder(seq2.end())
                .lineToLinearHeading(new Pose2d(50, 49, Math.toRadians(180)))
                .build();
        ...
        TrajectorySequence seq5 = drive.trajectorySequenceBuilder(seq4.end())
                .lineToLinearHeading(new Pose2d(39.5, 5, Math.toRadians(0)))
                .build();
        ...
        TrajectorySequence seq6 = drive.trajectorySequenceBuilder(seq5.end())
                .lineToLinearHeading(new Pose2d(63,48, Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(68,48, Math.toRadians(180)))
                .build();
